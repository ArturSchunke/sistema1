...
(1, 'A menina que roubava livros', '45.90', 2),
(2, 'Diario de um banana', '32.90', 2),
(3, 'crepusculo', '29.90', 2),
(4, 'A lista de Schindler', '37.90', 3),
(5, 'A teoria de tudo', '42.80', 4),
(6, 'O guia do mochileiro da galaxia', '46.90', 4);

-- --------------------------------------------------------

--
-- Estrutura stand-in para vista `books_by_unit`
-- (Veja abaixo para a view atual)
--
CREATE TABLE `books_by_unit` (
`id` int(11)
,`title` varchar(100)
,`price` decimal(8,2)
,`city` varchar(50)
...
CREATE TABLE `employees` (
  ...
  `data_admission` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Estrutura da view `books_by_unit` exportado como tabela
--
DROP TABLE IF EXISTS `books_by_unit`;
CREATE TABLE`books_by_unit`(
...
ALTER TABLE `installments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_installments_id_order` (`id_order`);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_id_category` FOREIGN KEY (`id_category`) REFERENCES `categorias` (`id`),
